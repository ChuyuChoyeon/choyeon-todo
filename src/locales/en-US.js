export default {
  ...
  about: {
    title: 'About',
    tagline: 'A modern cross-platform task management app that keeps every day organized',
    smartTask: 'Smart Task Management',
    smartTaskDesc: 'Natural language input, auto-detect time and priority',
    calendarView: 'Calendar View',
    calendarViewDesc: 'Month view and timeline, master your schedule',
    pomodoro: 'Pomodoro Focus',
    pomodoroDesc: 'Immersive focus mode, boost productivity',
    analytics: 'Data Analytics',
    analyticsDesc: 'Multi-dimensional visual analysis, find your rhythm',
    madeWith: 'Made with',
    author: 'Choyeon',
